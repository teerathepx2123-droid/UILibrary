	...
	[27] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(27)local TweenService = game:GetService("TweenService")
		...
		function Element:New(Idx, Config)
			...
			function Toggle:SetValue(Value)
				...
				if Toggle.Value then ToggleCircle.ImageColor3 = Color3.fromRGB(255, 255, 255) else Creator.OverrideTag(ToggleCircle, { ImageColor3 = "ToggleSlider" }) end
				TweenService:Create(
					ToggleCircle,
					TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
					{ Position = UDim2.new(0, Toggle.Value and 16 or 2, 0.5, 0) }
				):Play()
				TweenService:Create(
					ToggleSlider,
					TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
