...
local v8 = {} do
    ...
    local v9 = {
        "GothamSSm", "Gotham", "Arial", "Code", "RobotoMono",
        "Ubuntu", "Nunito", "Merriweather", "Oswald", "SourceSansPro",
    }
    local v10 = {
    ...
    function v8:BuildFolderTree()
        ...
        if not isfolder("FractureHub/Ui Config") then makefolder("FractureHub/Ui Config") end
    end
    ...
    function v8:LoadSettings()
        local v35 = v8.Folder .. "/options.json"
        if isfile(v35) then
    ...
    function v8:BuildInterfaceSection(v53)
        ...
        local v60 = v59:AddDropdown("InterfaceTheme", {Title = "Select Theme", Values = v54.Themes, Default = v55.Theme, Callback = function(v61) v54:SetTheme(v61) v55.Theme = v61 v8:SaveSettings() end})
        v59:AddToggle("TransparentToggle", {Title = "Transparency", Default = v55.Transparency, Callback = function(v62) v54:ToggleTransparency(v62) v55.Transparency = v62 v8:SaveSettings() end})
        v59:AddDropdown("FontManager", {Title = "Select Font", Values = v9, Default = v55.Font or "GothamSSm", Callback = function(v63) v55.Font = v63 v8:SaveSettings() v8:ApplyFont(v63) end})
        ...
        local v65 = v59:AddDropdown("InterfaceLanguage", {Title = "Select Language", Values = v11, Default = v55.Language or "English", Callback = function(v66) v8:ApplyLanguage(v66) end})
